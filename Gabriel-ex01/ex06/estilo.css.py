...
#resumo {grid-area:resumo} #tarefas{grid-area:tarefas} #agenda{grid-area:agenda} #equioe{grid-area:equipe} #alertas{grid-area;alertas} 
...
@media(max-width:760px){ #dashboard{grid-template-columns:1fr;grid-template-areas: "resumo resumo" "tarefas" "agenda" "equipe" "alertas"; } }